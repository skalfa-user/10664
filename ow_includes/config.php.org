...
define('OW_URL_HOME', 'https://www.a1mela.com/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'sanjayp3_Sanj');
define('OW_DB_PASSWORD', 'ZfXbw%2A.5hE');
define('OW_DB_NAME', 'sanjayp3_Sanj');
...
define('OW_PASSWORD_SALT', '5e9704f7db53f');

 ...
 * @package ow_plugins.lapge.components
 * @since 1.8.6
 */
class LPAGE_CMP_Notification extends OW_Component
{
    private $items = array();
    private $user;
    ...
    {
        $template = OW::getPluginManager()->getPlugin('lpage')->getCmpViewDir() . 'notification_html.html';
    ...
    {
        $template = OW::getPluginManager()->getPlugin('lpage')->getCmpViewDir() . 'notification_txt.html';
        $this->setTemplate($template);
